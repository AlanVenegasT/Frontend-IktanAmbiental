...
const FondoTexto = () => {
  return (
    <>
     <div className="relative bg-[#091D3E] mt-20">
      ...
      <div className="relative mx-auto max-w-7xl py-24 sm:py-32 lg:py-40 lg:px-8">
        ...
        <h3 className="font-medium text-lg bg-clip-text text-transparent bg-gradient-to-r from-[#0F4FBB] to-[#02BEF8] ">WHO WE ARE</h3>
          <p className="mt-2 text-3xl font-bold  text-white">How do we manage IT services for your industry</p>
          ...
          <div className=" flex flex-row  mt-8 border-t-2 border-[#3A4A65] pt-6 ">
            <div className='flex flex-row basis-1/2 pl-2'>
                ...
                <p className='basis-2/3 text-xs text-white'>Have any Questions? <span className='font-bold'> info@crysta.com </span> </p>
            </div>
            <div className='flex flex-row basis-1/2 pl-4'>
                <img className='basis 1/3 h-10 w-10 ' src="" alt="" />
                <p className='basis-2/3 text-xs text-white flex items-center pl-4 font-bold'>WATCH PROCESS</p>
            </div>
          </div>
        </div>
      </div>
