  ...
  return (
    ...
    <div className="" id="cumplimiento">
      ...
      <div className=" max-w-4xl  mx-auto">
        ...
        <div className="absolute bg-black/90 h-[450px] w-[600px] -translate-x-40 -translate-y-[550px] shadow-2xl rounded-lg">
          <p className="text-[#B7B7B7] text-base px-12 text-justify pb-5 pt-20">
          ...
          <p className="text-[#B7B7B7] text-base px-12 text-justify py-5">
          ...
          <div className="flex flex-col absolute bg-white border-2 border-[#F4F4F4] h-[340px] w-[270px] translate-x-40 -translate-y-[490px] shadow-lg">           
            ...
            <div className="basis-1/3 py-5 px-5">
              ...
              <div className="flex py-2">
                ...
                <p className="px-2 text-base ">Reparación y monitoreo.</p>
              </div>
              <div className="flex py-2 ">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
