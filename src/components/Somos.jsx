    ...
    <>
      <div className=" flex flex-row"> {/*padre */}
        <div className=" basis-1/2 bg-[#AEC90A]  " >{/*hijo1 izquierda */}
              ...
              <h2 className="text-4xl font-medium text-white absolute translate-x-40 -translate-y-64  ">Quienes somos? </h2>
              <h2 className="text-5xl font-medium text-white absolute translate-x-40 -translate-y-52 ">IKTAN Ambiental</h2>
        </div>
        <h2></h2>
        <div className=" basis-1/2 bg-white text-justify text-sm px-20 ">{/*hijo2 derecha */}

        <img className="w-full h-full relative blur-sm" src="Hojas.png" alt="" />
