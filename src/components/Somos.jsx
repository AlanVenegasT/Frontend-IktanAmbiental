...
const Somos = () => {
  ...
  return (
    <>
      <div ref={revealRef}>
      <div className=" mx-auto flex flex-col md:flex md:flex-col lg:flex lg:flex-row xl:flex xl:flex-row max-w-7xl md:max-w-2xl lg:max-w-4xl xl:max-w-7xl  mt-20 md:mt-32 lg:mt-24 xl:mt-32 "> {/*Padre */}
        ...
        <div className=" basis-1/2  pl-6 pt-36 md:pl-12 md:pt-0 lg:pl-14 lg:pt-0 xl:pl-20 xl:pt-0  first-letter:"> {/*Texto */}
          <div>
            <h2 className=" md:mt-14 lg:mt-14 xl:mt-14 font-medium text-base md:text-base lg:text-base xl:text-lg bg-clip-text text-transparent bg-gradient-to-r from-[#0F4FBB] to-[#02BEF8] ">CONOCENOS</h2>
            <h3 className="pr-32 md:pr-40 lg:pr-32 xl:pr-40 md:text-xl lg:text-2xl  xl:text-3xl font-bold py-2 md:py-2 lg:py-3 xl:py-5  leading-6 md:leading-10 lg:leading-10 xl:leading-10 text-[#232323] ">Consultoría especializada en el sector hidrocarburos</h3>
            <p className="text-[#66667F] leading-5 md:leading-7 lg:leading-7 xl:leading-7 text-sm md:text-base lg:text-xs xl:text-base text-justify pr-5 md:pr-0 lg:pr-0 xl:pr-0 ">En IKTAN Ambiental tenemos el compromiso de ofrecer a nuestros clientes la orientación
y los servicios necesarios para que logren el desarrollo exitoso de proyectos en el sector hidrocarburos.
          ...
          <div className="flex flex-row pt-6 md:pt-6 lg:pt-6 xl:pt-10   ">
            ...
            <div className=" basis-1/2">
              ...
              <p className="text-[#66667F] leading-5 md:leading-7 lg:leading-7 xl:leading-7 text-sm lg:text-xs xl:text-base pr-3 md:pr-3 lg:pr-3 xl:pr-3  text-justify ">Ser una referencia mundial en el desarrollo de proyectos del sector hidrocarburos.</p>
            </div>
          </div>

          <div className="flex">
            <h2 className="text-6xl md:text-7xl mt-10 font-bold text-green-600 ">95%</h2>
            <h3 className="pr-24 md:pr-72 lg:pr-40 xl:pr-40 pt-16 md:pt-16 lg:pt-16 xl:pt-28 pl-4 font-bold text-[#232323] lg:text-xs xl:text-lg  ">Satisfacción del Cliente 2022</h3>
          </div>
