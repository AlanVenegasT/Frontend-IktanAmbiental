    ...
    <img className="absolute h-[550px] lg:h-[500px] xl:h-[550px] flex right-0 translate-y-72 lg:translate-y-52 xl:translate-y-72" src=" Lineas.png " alt="" />
     ...
     <div className=" mx-auto max-w-7xl"> {/*Div general */}
      <div className="flex flex-row -translate-y-28 " > {/*Cuadros de texto */}
        <div className="flex flex-row basis-1/2 bg-gradient-to-r from-[#022391] via-[#0747B6] to-[#0D6ADB] mx-3">
            ...
            <div className="basis-2/3">
              <h3 className="text-white font-semibold text-2xl pl-5 pt-14 pb-6 lg:text-xl lg:pl-5 lg:pt-8 lg:pb-6 xl:text-2xl xl:pl-5 xl:pt-14 xl:pb-6 ">Customer satisfaction</h3>
              <p className="text-white px-5 leading-8 pb-12 text-lg lg:pb-6 lg:text-base xl:pb-12 xl:text-lg ">Pointure horrible margaret suitable he followed speedily. Indeed vanity excuse or mr lovers of on. By offer scale an stuff. Blush be sorry no sight sang lose ecstatic and properly.</p>
            </div>
        </div>
        <div className="basis-1/2 bg-gradient-to-r from-[#00112E] via-[#0055F1] to-[#0059FC] mx-3 py-4 overflow-hidden ">
          ...
          <h2 className=" text-white font-semibold text-6xl pt-7 pl-8 lg:text-4xl lg:pt-4 lg:pl-8 xl:text-6xl xl:pt-7 xl:pl-8">45 k</h2>
          <h3 className=" text-white font-semibold pl-8 py-3 text-2xl lg:pl-8 lg:py-3 lg:text-xl xl:pl-8 xl:py-3 xl:text-2xl">Customers worldwide</h3>
          <p className=" text-white pr-24 pl-8 leading-7 text-lg lg:text-base xl:text-lg">Mentioning horrible margaret suitable he followed speedily. Indeed vanity excuse or mr lovers of on. By offer scale an stuff. Blush be sorry no properly.</p>
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-row"> {/*Seccion restante */}
          ...
          <h2 className="font-medium text-lg lg:text-base xl:text-lg bg-clip-text text-transparent bg-gradient-to-r from-[#0F4FBB] to-[#02BEF8] ">WHY CHOOSE US</h2>
          <h3 className=" text-4xl lg:text-2xl xl:text-4xl font-semibold pr-60 lg:pr-52 xl:pr-60 py-6 lg:py-3 xl:py-6">Our goal is giving the best our customers</h3>
          <p className="pr-32 text-justify leading-8 lg:leading-6 xl:leading-8 text-base lg:text-base xl:text-base ">Jennings appetite disposed me an at subjects an. To no indulgence diminution so discovered mr apartments. Are off under folly death wrote cause her way spite. Plan upon yet way get cold spot its week. Almost do am or limits hearts. Resolve parties but why she shewing. She sang know now</p>
