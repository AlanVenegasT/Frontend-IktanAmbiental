...
const Imagen2en1 = () => {
  ...
  return (
    <>
    <div ref={revealRef}>
    <h2 className="font-medium text-base md:text-base lg:text-base xl:text-lg text-center mt-6 md:mt-6 lg:mt-6 xl:mt-12 bg-clip-text text-transparent bg-gradient-to-r from-[#0F4FBB] to-[#02BEF8] ">DETECCION Y CUANTIFICACION</h2>
